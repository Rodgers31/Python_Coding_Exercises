...
#
#
# IMPORTANT: The exception handling should NOT allow each fruit to be printed
# when there is an exception. e.g. it should not print out Apple pie, Pear pie
# and Orange pie, when there is an exception it should only print "Fruit pie".
